...
export default function NavbarComponent() {
  return (
    <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 bg-black text-primary">
      <Sheet>
        <SheetTrigger asChild>
          <Button variant="outline" size="icon" className="lg:hidden bg-black border outline-primary border-primary">
            <Menu className="h-6 w-6" />
            <span className="sr-only">Abrir menu de navegação</span>
          </Button>
        </SheetTrigger>
        <SheetContent side="left" className="bg-black text-primary">
